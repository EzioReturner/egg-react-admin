(window.webpackJsonp = window.webpackJsonp || []).push([
  [64, 94, 98],
  {
    368: function(e, t, a) {
      'use strict';
      a.r(t),
        a.d(t, 'BoxSvg', function() {
          return i;
        }),
        a.d(t, 'EmpolyeesSvg', function() {
          return d;
        }),
        a.d(t, 'OrdersSvg', function() {
          return h;
        }),
        a.d(t, 'SalesSvg', function() {
          return s;
        }),
        a.d(t, 'RainSvg', function() {
          return m;
        }),
        a.d(t, 'SnowSvg', function() {
          return f;
        }),
        a.d(t, 'CloudySvg', function() {
          return u;
        }),
        a.d(t, 'OvercastSvg', function() {
          return p;
        }),
        a.d(t, 'ThunderSvg', function() {
          return v;
        }),
        a.d(t, 'SunSvg', function() {
          return E;
        }),
        a.d(t, 'RLogo', function() {
          return c;
        }),
        a.d(t, 'RLogo1', function() {
          return r;
        }),
        a.d(t, 'FogSvg', function() {
          return o;
        });
      var l = a(1),
        n = a.n(l),
        c = function() {
          return n.a.createElement(
            ...
            n.a.createElement('defs', null, n.a.createElement('style', { type: 'text/css' })),
    ...
    379: function(e, t, a) {
      ...
      var l = a(100);
      function n() {
        return l.default.sendRequest('get', {
            ...
            Object(c.a)(t, [
              {
                ...
                value: function() {
                  var e = this;
                  Object(m.default)().then(function(t) {
                    var a = t.data,
                      l = a.status,
                      n = a.forecasts;
                    1 === Number(l) &&
                      e.setState({
                        data: n[0].casts.map(function(e) {
                          return {
                            daypower: e.daypower,
                            daytemp: e.daytemp,
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  return (
                    e.indexOf('\u96f7') >= 0
                      ? (t = s.a.createElement(p.ThunderSvg, null))
                      : e.indexOf('\u96e8') >= 0
                      ? (t = s.a.createElement(p.RainSvg, null))
                      : e.indexOf('\u4e91') >= 0
                      ? (t = s.a.createElement(p.CloudySvg, null))
                      : e.indexOf('\u9634') >= 0
                      ? (t = s.a.createElement(p.OvercastSvg, null))
                      : e.indexOf('\u6674') >= 0 && (t = s.a.createElement(p.SunSvg, null)),
                    t
                  );
                }
              },
                  ...
                  var e = this,
                    ...
                    c = a.map(function(t, a) {
                      ...
                      return s.a.createElement(
                        'div',
                        { className: 'weakly-weather-item p-3', key: a },
                        s.a.createElement('p', { className: 'mb-1' }, n[Number(l - 1)]),
                        e.getWeatherIcon(i),
                        s.a.createElement(
                          'p',
                          { className: 'mb-0' },
                  ...
                  return s.a.createElement(
                    ...
                    s.a.createElement(
                      ...
                      s.a.createElement(
                        ...
                        s.a.createElement('h2', null, u()().format('dddd')),
                        s.a.createElement(
                          'p',
                          { className: 'text-muted' },
                          u()().format('DD MMMM, YYYY'),
                          ' Amoy, China'
                        )
                      ),
                      s.a.createElement(
                        ...
                        s.a.createElement(
                          'h1',
                          null,
                          a[0] ? a[0].daypower + '\u2103 - ' + a[0].daytemp + '\u2103' : ''
                        )
                      )
                    ),
                    s.a.createElement('div', { className: 'weakly-weather' }, c)
                  );
                }
              }
            ]),
...
//# sourceMappingURL=64.30ed254b.chunk.js.map
